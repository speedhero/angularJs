 ...
 * @restrict A
 */
app.directive('ngTablePagination', ['$compile','$window',
    function ($compile, $window) {
        ...
        return {
            ...
            link: function (scope, element, attrs) {
                ...
                /**
                 * add by patrick
                 * @type {Math|*|exports.ecmaIdentifiers.Math|$scope.Math}
                 */
                scope.Math = $window.Math;

                scope.pageToGo = scope.params.page();
                 ...
                 * add by patrick
                 */
                scope.gotoPage = function(pageToGo, totalPage){
                    var page  = parseInt(pageToGo);
                    if(isNaN(page) || page <=0 || page>totalPage){
                        $window.alert("请输入大于0，且小于等于"+totalPage+"的整数");
                        return;
                    }
                 ...
                 * dd by patrick
                 */
                scope.gotoPageSimple = function(page){
                    scope.pageToGo = page;
                    scope.params.page(page);
                };
                ...
                scope.totalPage = function(){
                    return scope.Math.ceil(scope.params.total()/scope.params.count());
                };
...
angular.module('ngTable').run(['$templateCache', function ($templateCache) {
	...
	$templateCache.put('ng-table/header.html', '<tr> <th ng-repeat="column in $columns" ng-class="{ \'sortable\': parse(column.sortable), \'sort-asc\': params.sorting()[parse(column.sortable)]==\'asc\', \'sort-desc\': params.sorting()[parse(column.sortable)]==\'desc\' }" ng-click="sortBy(column, $event)" ng-show="column.show(this)" ng-init="template=column.headerTemplateURL(this)" class="header {{column.class}}"> <div ng-if="!template" ng-show="!template" ng-bind="parse(column.title)"></div> <div ng-if="template" ng-show="template"><div ng-include="template"></div></div> </th> </tr> <tr ng-show="show_filter" class="ng-table-filters"> <th ng-repeat="column in $columns" ng-show="column.show(this)" class="filter"> <div ng-repeat="(name, filter) in column.filter"> <div ng-if="column.filterTemplateURL" ng-show="column.filterTemplateURL"> <div ng-include="column.filterTemplateURL"></div> </div> <div ng-if="!column.filterTemplateURL" ng-show="!column.filterTemplateURL"> <div ng-include="\'ng-table/filters/\' + filter + \'deliverTable.html\'"></div> </div> </div> </th> </tr>');
