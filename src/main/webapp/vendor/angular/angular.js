...
function startingTag(element) {
  ...
  try {
    // turns out IE does not let you set deliverTable.html() on elements which
...
function validate(ctrl, validatorName, validity, value){
  ...
  //modified by patrick, 使得当最大长度超出的时候仍然显示value
  if(('maxlength' === validatorName) || ('minlength' === validatorName)){
      return value;
  }else{
